        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                foreach ($resultArray as $item){
                    cartItem($item['image'],$item['title'],$item['unit_price'],$item['brand'],$item['item_id'],$item['quantity']);
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        <h5 class="font-baloo font-size-20">Subtotal (<?php echo $number_of_items ?> item):&nbsp;<span class="text-danger">$<span class="text-danger" id="deal-price"><?php echo $subtotal ?></span> </span> </h5>
